...
class DistributorsControllerTest < ActionController::TestCase
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post :create, distributor: { address: @distributor.address, city: @distributor.city, logo_url: @distributor.logo_url, name: @distributor.name, state: @distributor.state, website: @distributor.website, zip: @distributor.zip }
    end
  ...
  test "should update distributor" do
    patch :update, id: @distributor, distributor: { address: @distributor.address, city: @distributor.city, logo_url: @distributor.logo_url, name: @distributor.name, state: @distributor.state, website: @distributor.website, zip: @distributor.zip }
    assert_redirected_to distributor_path(assigns(:distributor))
  end
