namespace :db do
  task :full_reset do
    ...
    Rake::Task['db:seed:movies'].invoke
    Rake::Task['db:seed:genres_movies'].invoke
...
namespace :db do
  namespace :seed do
    ...
    desc "Seed genre data to the db"
    ...
    desc "Seed movie data to the db"
    ...
    desc "Seed movie genre join data to the db"
    task :genres_movies => :environment do
